...
<div class="col py-3">
    ...
    <form method="POST">
        <div class="mb-3">
            ...
            <input value="<?= $admin->getNome() ?>" name="nome" type="text" class="form-control" placeholder="Digite seu nome">
        </div>
        <div class="mb-3">
            <label class="form-label">E-mail</label>
            <input value="<?= $admin->getEmail() ?>" name="email" type="email" class="form-control" placeholder="Digite seu email">
        </div>
        <div class="mb-3">
